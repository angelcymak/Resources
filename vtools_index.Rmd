...
2. First import the variants  
vtools import /home/data/file.vcf --format vcf --build hg19 --var_info id filter  
  
3. Next import custom annotations in vcf format  
3.1 Generate a custom .ann file (define what annotations you will be importing; See dropbox for an example)  
